...
const WHATSAPP_CARD_RECEIVED_TEMPLATE_NAME = process.env.WHATSAPP_CARD_RECEIVED_TEMPLATE_NAME || 'card_intro';
const WHATSAPP_BUSINESS_CARD_TEMPLATE_NAME = process.env.WHATSAPP_BUSINESS_CARD_TEMPLATE_NAME || 'card_intro';
const WHATSAPP_SCAN_TEMPLATE_NAME = process.env.WHATSAPP_SCAN_TEMPLATE_NAME || 'card_intro';
